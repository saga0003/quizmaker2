...
expect("validated Excel template", workbook.includes("dataValidations") && workbook.includes("evidara-question-import-template.xlsx") && workbook.includes("Image ZIP") && importParser.includes("bulkQuestionTemplateHeaders"), "validated Excel and image ZIP template support is missing");
