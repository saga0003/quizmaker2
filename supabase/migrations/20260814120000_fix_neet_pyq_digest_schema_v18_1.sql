-- Evidara V18.1 correction: pgcrypto is installed in the `extensions` schema on Supabase.
-- This redefines the existing review-staging importer so fresh question inserts can compute hashes.
