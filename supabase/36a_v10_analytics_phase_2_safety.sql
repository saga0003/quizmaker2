...
alter function public.get_teacher_analytics_overview_v10(uuid,date,date)
  rename to get_teacher_analytics_overview_base_v10;
...
declare
  ...
  v_students jsonb;
begin
  v_payload := public.get_teacher_analytics_overview_base_v10(p_section_id,p_from,p_to);
...
revoke execute on function public.get_teacher_analytics_overview_base_v10(uuid,date,date) from authenticated;

insert into public.audit_logs(actor_id,action,entity_type,entity_id,metadata)
values(null,'analytics.v10.phase2.safety_ready','system','36a_v10_analytics_phase_2_safety',
  jsonb_build_object('batch_unique_sections',true,'distinct_student_status_counts',true,'rpc_compatibility',true));
