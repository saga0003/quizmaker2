...
export default function ProductsPage() {
  ...
  return (
    <>
      <Navbar />
      <main className="rm-container" style={{ padding: 'clamp(24px,6vw,46px) 0 70px' }}>
        <div style={{ maxWidth: 800, marginBottom: 28 }}>
          <span className="rm-label">Evidara Paper Series</span>
          <h1 style={{ fontSize: 'clamp(36px,6vw,54px)', lineHeight: 1.08, color: 'var(--foreground)', margin: '8px 0 12px' }}>Choose the right series for a student or school</h1>
