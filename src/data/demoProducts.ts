...
export const demoProducts: StoreProduct[] = [
  {
    ...
    product_type: "test_series", audience: "student", exam_type: "NEET", grade_levels: ["Grade 11", "Grade 12", "NEET Long Term"],
    cover_image_url: null, gallery_image_urls: [], image_alt_text: "NEET Complete Test Series",
    is_featured: true, version_id: "demo-neet-v1", mrp_paise: 599900, selling_price_paise: 199900,
    access_days: 365, max_attempts: 20, student_limit: null, paper_count: 20, papers: [],
  ...
  },
  {
    ...
    product_type: "test_series", audience: "student", exam_type: "JEE Main", grade_levels: ["Grade 11", "Grade 12", "JEE Long Term"],
    cover_image_url: null, gallery_image_urls: [], image_alt_text: "JEE Main Practice Series",
    is_featured: false, version_id: "demo-jee-v1", mrp_paise: 399900, selling_price_paise: 149900,
    access_days: 180, max_attempts: 15, student_limit: null, paper_count: 15, papers: [],
  ...
  },
  {
    ...
    product_type: "school_subscription", audience: "school", exam_type: null, grade_levels: [],
    cover_image_url: null, gallery_image_urls: [], image_alt_text: "School Starter Plan",
    is_featured: false, version_id: "demo-school-v1", mrp_paise: 999900, selling_price_paise: 599900,
    access_days: 365, max_attempts: null, student_limit: 100, paper_count: 20, papers: [],
