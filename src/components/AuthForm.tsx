...
type DemoAccount = { id:string; label:string; fullName:string; email:string; legacyEmail?:string; username:string; password:string; role:DemoRole; route:string };
...
export function AuthForm() {
  ...
  return <div className="so-card" style={{padding:24,maxWidth:540,width:"100%"}}>
    ...
    <p style={{margin:"0 0 20px",color:"#6B7980",lineHeight:1.55}}>{!isSupabaseConfigured?"Interactive demo: open a role below or use its Evidara demo email and password.":mode==="register"?"Create your Evidara identity and begin immediately.":"Use Google or your email and password."}</p>
