...
import { BarChart3, BookOpenCheck, Building2, CalendarRange, ChevronRight, CircleHelp, ClipboardList, CreditCard, FileQuestion, GraduationCap, Home, Layers3, LogOut, Package, Settings, ShieldCheck, Sparkles, TableProperties, Upload, Users } from "lucide-react";
...
const links:{[K in Kind]:{h:string;l:string;i:typeof Home;tag?:string}[]}={
  ...
  admin:[
    {h:"/admin/",l:"Command Centre",i:Home},{h:"/admin/subscriptions/",l:"School Subscriptions",i:CreditCard},{h:"/admin/questions/",l:"Master Question Bank",i:FileQuestion},{h:"/admin/questions/import/",l:"Bulk Import",i:Upload},{h:"/admin/papers/",l:"Assessment Catalogue",i:ClipboardList},{h:"/admin/products/",l:"Plans & Pricing",i:Package},{h:"/metric-guide/",l:"Metric Guide",i:CircleHelp},{h:"/data-guide/",l:"Data Controls",i:TableProperties},{h:"/setup-check/",l:"System & Security",i:ShieldCheck},
  ],
};
