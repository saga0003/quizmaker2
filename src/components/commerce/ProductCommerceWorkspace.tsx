  ...
  return (
    <div className={`${styles.workspace} space-y-6`}>
      <div>
        ...
        <h1 className="mt-2 text-3xl font-extrabold tracking-tight text-[#14232B]">Products, vouchers and commerce reporting</h1>
      ...
      <Tabs defaultValue="products">
        <TabsList className="h-auto w-full justify-start gap-1 overflow-x-auto rounded-none border-b border-[#E7ECEB] bg-transparent p-0">
          ...
          <TabsTrigger value="analytics" className="rounded-none border-b-2 border-transparent px-4 py-3 data-[state=active]:border-[#0E5A5A] data-[state=active]:bg-transparent data-[state=active]:text-[#0E5A5A] data-[state=active]:shadow-none"><BarChart3 className="mr-2 h-4 w-4" />Reporting</TabsTrigger>
        </TabsList>
